...
const TimeLine = (props) => {
    ...
    const renderPostData = ({ item }) => {
        return (
            <PostCard post={item}
             onSelect = { () => props.navigation.navigate('PostPage2', {selectedPost: item})} //!! o sayfaya git. yanında parametre geçir
                
            /> //buradan çağırdık. buradan alırız(postCard.dan geldi.)
        )
    }


    return ( //ItemSeparatorComponent her gönerinin arasına çizgi için
        <SafeAreaView>
            <View>
